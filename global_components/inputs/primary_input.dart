...
import 'package:boris_ilic_portfolio/global_components/custom_outline_input_border.dart';
import 'package:flutter/material.dart';
import 'package:flutter/services.dart';

typedef OnFocusChanged = void Function(bool hasFocus);

/// Example of one complex component
...
class PrimaryInput extends StatefulWidget {
  ...
  })  : assert(isValidationEnabled && controller != null && fieldKey != null ||
            !isValidationEnabled),
        super(key: key);
      ...
      children: [
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: FontStyles.fontRegular14
                          .apply(color: ColorPalette.red30),
                    ),
                  ],
                ),
              )
        ...
        TextFormField(
          ...
          focusNode: widget.focusNode ??
              (widget.isValidationEnabled ? _inputFocus : null),
          ...
          style: FontStyles.fontRegular14.copyWith(
            color: widget.isEnabled
                ...
                : ColorPalette.gray10.withOpacity(0.5),
            height: 1.2,
          ...
          decoration: InputDecoration(
            filled: true,
            fillColor:
                !widget.isEnabled ? ColorPalette.gray10 : ColorPalette.purple30,
            ...
            label: widget.isRequired
                ? Text(
                    '${widget.isNewUserField ? widget.labelText : widget.hintText}${widget.isRequired ? ' *' : ''}',
            ...
            floatingLabelBehavior: widget.isNewUserField
                ? FloatingLabelBehavior.auto
                : FloatingLabelBehavior.never,
            labelStyle: widget.isNewUserField
                ? FontStyles.fontRegular14.copyWith(
                    color: ColorPalette.gray10,
                ...
                : null,
            hintStyle: FontStyles.fontRegular14.copyWith(
              color: widget.isTextArea!
                  ? ColorPalette.gray10
                  : ColorPalette.gray10,
              overflow: TextOverflow.ellipsis,
            ),
            ...
            border: widget.isNewUserField
                ? CustomOutlineInputBorder(
                    ...
                    borderSide: widget.borderSide ??
                        const BorderSide(color: ColorPalette.gray30),
                  )
                : OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12.0),
            ...
            focusedBorder: widget.isNewUserField
                ? CustomOutlineInputBorder(
                    borderRadius: BorderRadius.circular(12.0),
                    borderSide: widget.borderSide ??
                        const BorderSide(color: ColorPalette.purple30),
                  )
                : OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12.0),
                    borderSide: widget.borderSide ??
            ...
            errorBorder: widget.isNewUserField
                ? CustomOutlineInputBorder(
                    ...
                    borderSide: widget.errorBorderSide ??
                        const BorderSide(color: ColorPalette.red50),
                  )
                : OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12.0),
                    borderSide: widget.errorBorderSide ??
